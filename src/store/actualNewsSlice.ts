...
const initialState: ActialNewsState = {
    actualNews: [
        ...
        },
        {
            ...
            litleDescription: 'Побудувати міст на цьому місці збирались ще за часів Радянського союзу. Обидва парки користуються популярністю та знаходяться в історичних місцях, тому між ними потрібен зручний перехід',
            fullDescription: 'full description',
            date: {
                dateNumber: '03',
                month: 'червня',
